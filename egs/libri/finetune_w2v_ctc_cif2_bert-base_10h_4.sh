...
SAVE_DIR=exp/finetune_w2v_ctc_cif2_bert_10h_4
DATA_DIR=data/light
label_type=word
...
--lambda-ctc 0.0 --lambda-qua 0.5 --lambda-embedding 0.05 --lambda-ac 1.0 --lambda-lm 0.2 \
...
--feature-grad-mult 0.0 --freeze-finetune-updates 500 --freeze-lm-finetune-updates 3000 \
--gold-rate-steps '(5000,10000)' --gold-rate-range '(0.8, 0.4)' \
--validate-after-updates 15000  --validate-interval 2 --save-interval 2 \
...
--log-interval 200 --log-format simple --remove-bpe '@@ '
