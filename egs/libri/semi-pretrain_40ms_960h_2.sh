gpu=$1
SAVE_DIR=exp/semi_pretrain_40ms_960h_2/
DATA_DIR=data/phone
...
--task audio_ctc --labels phone --criterion wav2vec_semi --arch wav2vec2_semi --enable-padding \
...
--lr 0.0005 --warmup-updates 32000 --mask-length 10 --mask-prob 0.3 --mask-selection static --mask-other 0 \
