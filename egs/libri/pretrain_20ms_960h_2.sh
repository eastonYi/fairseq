gpu=$1
SAVE_DIR=exp/pretrain_20ms_960h_2/
DATA_DIR=data
...
--lr 0.0005 --warmup-updates 32000 --mask-length 5 --mask-prob 0.65 --mask-selection static --mask-other 0 \
...
--log-format simple --log-interval 200 --update-freq 40 --save-interval 1
