...
dict=/home/easton/projects/wav2vec/egs/libri/data/lang_char/train_960_unigram5000_units.txt
encoded=/home/easton/projects/wav2vec/egs/libri/data/lang_char/train_960_unigram5000_encoded.txt
fairseq_dict=/home/easton/projects/wav2vec/egs/libri/data/lang_char/train_960_unigram5000_fairseq_dict.txt
bpemodel=/home/easton/projects/wav2vec/egs/libri/data/lang_char/train_960_unigram5000
...
spm_train --input=data/lang_char/input.txt --vocab_size=${nbpe} --model_type=${bpemode} --model_prefix=${bpemodel} --input_sentence_size=100000000 --unk_id=2 --eos_id=1 --pad_id=0 --bos_id=-1 --character_coverage=1
...
# bpemodel=/home/easton/projects/wav2vec/egs/libri/data/lang_char/train_960_unigram5000_encoded.txt
