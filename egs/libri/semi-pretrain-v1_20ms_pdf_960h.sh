gpu=$1
SAVE_DIR=exp/semi_pretrain_v1_20ms_pdf_960h/
DATA_DIR=data/pdf
...
--task audio_ali --labels pdf --ali-rate 2 --criterion wav2vec_v1 --arch wav2vec2_v1 \
...
--log-format simple --log-interval 500 --update-freq 8 --save-interval 1
