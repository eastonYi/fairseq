gpu=$1
SAVE_DIR=exp/semi_pretrain_20ms_960h_ctc0.0/
DATA_DIR=data/phone
...
--task audio_ctc --criterion wav2vec_semi --arch wav2vec2_semi \
--train-subset train --valid-subset valid --labels phone --no-epoch-checkpoints \
...
--max-tokens 400000 --max-update 400000 --skip-invalid-size-inputs-valid-test --ddp-backend no_c10d \
