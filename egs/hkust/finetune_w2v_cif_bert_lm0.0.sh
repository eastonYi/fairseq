...
SAVE_DIR=exp/finetune_w2v_cif_bert_lm_0.0
...
--lambda-ctc 1.0 --lambda-qua 0.2 --lambda-embedding 0.05 --lambda-lm 0.0 \
...
--gold-rate-steps '(5000, 10000)' --gold-rate-range '(0.6, 0.2)' \
