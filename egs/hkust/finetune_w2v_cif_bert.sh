...
SAVE_DIR=exp/finetune_w2v_cif_bert
...
--feature-grad-mult 0.0 --freeze-finetune-updates 500 --freeze-lm-finetune-updates 0 \
--gold-rate-steps '(0, 4000)' --gold-rate-range '(0.9, 0.2)' \
