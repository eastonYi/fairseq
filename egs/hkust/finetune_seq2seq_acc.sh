...
--num-workers 4 --max-update 80000 --task audio_seq2seq --arch wav2vec_seq2seq --w2v-path $W2V_PATH \
--decoder-embed-dim 768 --decoder-ffn-embed-dim 3072 --decoder-layers 6 --decoder-layerdrop 0.0 \
--decoder-learned-pos --decoder-normalize-before --labels $label_type \
...
--feature-grad-mult 0.0 --freeze-finetune-updates 1 --validate-after-updates 1  --validate-interval 1 \
