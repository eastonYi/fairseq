...
SAVE_DIR=exp/finetune_w2v_cif_bert_3.4
...
--lambda-ctc 2.0 --lambda-qua 0.2 --lambda-embedding 0.05 --lambda-lm 0.1 \
...
--gold-rate-steps '(1000, 5000)' --gold-rate-range '(0.8, 0.2)' \
