gpu=$1
SAVE_DIR=exp/finetune_w2v_cif_ma_2
...
--freeze-finetune-updates 2000 --teacher-forcing-updates 100000 \
--validate-after-updates 10000  --validate-interval 1 --decoder cif_decoder \
