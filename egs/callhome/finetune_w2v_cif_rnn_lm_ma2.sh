#!/bin/sh
gpu=$1
SAVE_DIR=exp/finetune_w2v_cif_rnn_lm_ma_2
...
--arch wav2vec_cif_rnn_lm --task audio_cif --criterion qua_ce_acc --best-checkpoint-metric acc \
...
--freeze-finetune-updates 2000 --freeze-lm-finetune-updates 5000 --teacher-forcing-updates 50000 \
