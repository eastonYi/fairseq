...
--train-subset train_small --valid-subset test \
...
--feature-grad-mult 0.0 --freeze-finetune-updates 10000 --validate-after-updates 10000  --validate-interval 1 \
...
--log-interval 50 --log-format simple --save-interval 20
