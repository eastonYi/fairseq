...
--arch wav2vec_seq2seq_lm --task audio_seq2seq --criterion ls_ce_acc \
--best-checkpoint-metric acc --maximize-best-checkpoint-metric \
--w2v-path $W2V_PATH --lm-path $LM_PATH --decoder seq2seq_lm_decoder \
--decoder-embed-dim 768 --decoder-ffn-embed-dim 1536 --decoder-layers 1 --decoder-layerdrop 0.0 \
--decoder-learned-pos --decoder-normalize-before --decoder-attention-heads 2 \
