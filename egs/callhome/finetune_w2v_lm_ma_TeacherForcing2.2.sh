gpu=$1
SAVE_DIR=exp/finetune_w2v_lm_teacher_forcing_2.2
...
--labels $label_type --num-workers 8 --max-update 800000 \
--arch wav2vec_lm --task audio_cif --criterion qua_ce_acc \
...
--freeze-finetune-updates 1000 --freeze-lm-finetune-updates 800000 --teacher-forcing-updates 50000 \
...
--attention-dropout 0.0 --max-tokens 500000 --max-sample-size 400000 --seed 2337 --ddp-backend no_c10d --update-freq 1 \
