gpu=$1
SAVE_DIR=exp/finetune_w2v_lm_teacher_forcing1.1
...
--arch wav2vec_lm --task audio_cif --criterion qua_ce_acc --lambda-qua 0.1 \
...
--feature-grad-mult 0.0 --freeze-finetune-updates 500 --freeze-lm-finetune-updates 80000 --teacher-forcing \
