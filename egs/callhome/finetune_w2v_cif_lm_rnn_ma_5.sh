gpu=$1
SAVE_DIR=exp/finetune_w2v_cif_lm_rnn_ma_5
...
--arch wav2vec_cif_lm_rnn --task audio_cif --criterion qua_ce_acc --best-checkpoint-metric acc \
--w2v-path $W2V_PATH --lm-path $LM_PATH --not-add-ctc-blank --maximize-best-checkpoint-metric \
--assigner-conv-layers '[(512,3,1)] * 2 + [(512,2,1)] * 1' --dim-hidden-mixer 512 \
...
--mask-channel-prob 0.5 --feature-grad-mult 0.0 --decoder-embed-dim 768 \
--freeze-finetune-updates 2000 --freeze-lm-finetune-updates 2000 --teacher-forcing-updates 80000 \
