gpu=$1
SAVE_DIR=exp/finetune_w2v_seq2seq_adddev
...
--train-subset train_dev --valid-subset dev --no-epoch-checkpoints  \
...
--feature-grad-mult 0.0 --freeze-finetune-updates 1000 --teacher-forcing-updates 20000 \
