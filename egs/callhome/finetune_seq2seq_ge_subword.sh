...
--feature-grad-mult 0.0 --freeze-finetune-updates 5000 --validate-after-updates 3000  --validate-interval 2000 \
...
--attention-dropout 0.0 --max-tokens 700000 --seed 2337 --ddp-backend no_c10d --update-freq 6 \
