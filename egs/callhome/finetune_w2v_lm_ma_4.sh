gpu=$1
SAVE_DIR=exp/finetune_w2v_lm_ma_4
...
--assigner-conv-layers '[(2048,3,1)] * 2 + [(2048,2,1)] * 1' --dim-hidden-mixer 1024 \
...
--feature-grad-mult 0.0 --freeze-finetune-updates 2000 --freeze-lm-finetune-updates 10000 \
...
--final-dropout 0.0 --dropout 0.0 --activation-dropout 0.1 --teacher-forcing-updates 10000 \
