gpu=$1
SAVE_DIR=exp/finetune_w2v_seq2seq_3
...
--w2v-path $W2V_PATH --w2v-update-rate 0.2 \
...
--attention-dropout 0.0 --max-tokens 700000 --seed 2337 --ddp-backend no_c10d --update-freq 1 \
