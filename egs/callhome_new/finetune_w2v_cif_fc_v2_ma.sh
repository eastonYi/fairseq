gpu=$1
SAVE_DIR=exp/finetune_w2v_cif_fc_v2_ma
...
--w2v-path $W2V_PATH --arch wav2vec_cif_fc_v2 --task audio_cif --criterion qua_ce_acc_v2 \
--lambda-alpha 0.0 --lambda-qua 0.1 \
...
--warmup-steps 5000 --hold-steps 40000 --decay-steps 30000 --final-lr-scale 0.05 \
--final-dropout 0.0 --dropout 0.0 --activation-dropout 0.1 \
--attention-dropout 0.0 --max-tokens 1100000 --seed 2337 --ddp-backend no_c10d --update-freq 1 \
