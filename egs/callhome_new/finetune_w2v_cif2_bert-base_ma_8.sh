...
SAVE_DIR=exp/finetune_w2v_cif2_bert_base_ma_8
...
--feature-grad-mult 0.0 --freeze-finetune-updates 500 --gold-updates 25000 --gold-rate-range '(0.9, 0.0)' \
...
--warmup-steps 5000 --hold-steps 15000 --decay-steps 30000 --final-lr-scale 0.05 \
