...
SAVE_DIR=exp/finetune_w2v_ctc_cif2_bert_base_en
...
--lambda-ctc 2.0 --lambda-alpha 0.0 --lambda-qua 0.5 --lambda-embedding 0.05 --lambda-lm 0.2 \
...
--feature-grad-mult 0.0 --freeze-finetune-updates 500 --gold-updates 4000 --gold-rate-range '(0.9, 0.4)' \
