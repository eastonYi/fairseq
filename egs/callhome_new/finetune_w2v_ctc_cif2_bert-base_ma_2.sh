...
SAVE_DIR=exp/finetune_w2v_ctc_cif2_bert_base_ma_2
...
--lambda-ctc 0.5 --lambda-alpha 0.0 --lambda-qua 0.1 --lambda-embedding 0.05 \
--arch wav2vec_ctc_cif2_bert --task audio_cif_bert --criterion ctc_cif_bert --best-checkpoint-metric uer \
--w2v-path $W2V_PATH --bert-name $BERT --infer-threash 1.0 --share-final-proj \
