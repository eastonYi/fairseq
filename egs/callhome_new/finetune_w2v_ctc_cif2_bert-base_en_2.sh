...
SAVE_DIR=exp/finetune_w2v_ctc_cif2_bert_base_en_2
...
--lambda-ctc 2.0 --lambda-alpha 0.0 --lambda-qua 0.5 --lambda-embedding 0.05 --lambda-lm 0.1 \
...
--feature-grad-mult 0.0 --freeze-finetune-updates 500 --freeze-lm-finetune-updates 2000 \
--gold-updates 8000 --gold-rate-range '(1.0, 0.4)' \
--validate-after-updates 4000  --validate-interval 4 --save-interval 4 \
