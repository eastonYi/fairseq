...
SAVE_DIR=exp/finetune_w2v_cif2_bertx6_200M_ma_2
...
--lambda-alpha 0.0 --lambda-qua 0.1 --lambda-embedding 0.01 \
...
--feature-grad-mult 0.0 --freeze-finetune-updates 500 --gold-updates 30000 --gold-rate-range '(0.9, 0.6)' \
