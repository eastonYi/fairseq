#!/bin/sh
gpu=$1
SAVE_DIR=exp/finetune_w2v_ctc_ma_from_IPA
# W2V_PATH=exp/finetune_w2v_ctc_scratch_ma_IPA_pretrain/checkpoint_best.pt
...
--no-epoch-checkpoints --reset-optimizer --reset-dataloader \
