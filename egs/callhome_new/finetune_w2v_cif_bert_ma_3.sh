...
SAVE_DIR=exp/finetune_w2v_cif_bert_ma_3
DATA_DIR=data/ma/bert_style
label_type=char
...
--lambda-ctc 1.0 --lambda-qua 0.5 --lambda-am 0.0 --lambda-lm 1.0 \
...
--gold-rate-steps '(1000, 4000)' --gold-rate-range '(0.9, 0.2)' \
