gpu=$1
SAVE_DIR=exp/finetune_w2v_seq2seq_lm_layer1
...
--arch wav2vec_seq2seq_lm --task audio_seq2seq --criterion ce_acc --best-checkpoint-metric uer \
--w2v-path $W2V_PATH --decoder seq2seq_decoder --reset-optimizer \
...
--freeze-lm-finetune-updates 10000 --validate-after-updates 5000  --validate-interval 2 \
