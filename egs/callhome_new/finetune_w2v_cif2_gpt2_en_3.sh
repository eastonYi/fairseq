...
GPT='gpt2'
SAVE_DIR=exp/finetune_w2v_cif2_gpt2_en_3
...
--lambda-ctc 1.0 --lambda-qua 0.5 --lambda-lm 0.5 \
...
--feature-grad-mult 0.0 --freeze-finetune-updates 500 --freeze-lm-finetune-updates 10000 \
--validate-after-updates 1000  --validate-interval 1 --save-interval 1 \
