gpu=$1
SAVE_DIR=exp/finetune_w2v_cif_nar_ma_layer4
...
--arch w2v_cif_nar --task audio_cif --criterion qua_ctc_ce --best-checkpoint-metric uer \
--w2v-path $W2V_PATH --lambda-ctc 1.0 --lambda-qua 0.5 \
...
--validate-after-updates 8000  --validate-interval 1 \
