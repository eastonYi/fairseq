...
GPT='gpt2'
SAVE_DIR=exp/finetune_w2v_cif2_gpt2V2_en_no-external-embed
...
--feature-grad-mult 0.0 --freeze-finetune-updates 500 --freeze-lm-finetune-updates 12000 \
--validate-after-updates 6000 --validate-interval 2 --save-interval 2 \
--gold-rate-steps '(1000, 10000)' --gold-rate-range '(1.0, 0.5)' \
