...
SAVE_DIR=exp/finetune_w2v_cif_BERT_wwm_ext_200M_ma
...
--arch wav2vec_cif_bertEx --task audio_cif --criterion qua_ce_acc_v2 --best-checkpoint-metric uer \
--w2v-path $W2V_PATH --not-add-ctc-blank \
--assigner-conv-layers '[(512,1,1)] * 1' \
