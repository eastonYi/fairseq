...
GPT='gpt2'
SAVE_DIR=exp/finetune_w2v_cif2_gpt2_2_en
...
--lambda-ctc 1.0 --lambda-qua 0.5 \
--arch w2v_cif_gpt2_2 --task audio_cif_gpt2 --criterion ctc_cif_gpt2 --best-checkpoint-metric uer \
...
--validate-after-updates 100  --validate-interval 1 --save-interval 1 \
