gpu=$1
SAVE_DIR=exp/finetune_w2v_cif_bert_ma_2
W2V_PATH=../libri/wav2vec2_small.pt
# LM_PATH=../language_model/hkust/exp/bert_hkust_char_add_callhome_ma/checkpoint_best.pt
LM_PATH=../language_model/hkust/exp/bertx4_hkust_char_add_callhome_ma/checkpoint_best.pt
...
--arch wav2vec_cif_bert --task audio_cif --criterion qua_ce_acc_v2 --best-checkpoint-metric acc \
...
--feature-grad-mult 0.0 --freeze-finetune-updates 1000 --freeze-lm-finetune-updates 2000 \
