#!/bin/sh
gpu=$1
SAVE_DIR=exp/finetune_w2v_ctc_ma_2
W2V_PATH=../libri/wav2vec2_small.pt
# SAVE_DIR=exp/finetune_w2v_ctc_ma_addaishell2
# W2V_PATH=../libri/wav2vec2_small_aishell2.pt
...
--mask-length 10 --mask-prob 0.1 --layerdrop 0.1 --mask-channel-selection static \
--mask-channel-other 0 --mask-channel-length 64 --mask-channel-prob 0.1 --zero-infinity \
