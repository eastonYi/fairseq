...
data_name=test
MODEL_PATH=exp/finetune_w2v_ctc_semipretrain_v1_addhkust_ma/checkpoint_best.pt
RESULT_DIR=exp/finetune_w2v_ctc_semipretrain_v1_addhkust_ma/decode_callhome_ma_beam1
