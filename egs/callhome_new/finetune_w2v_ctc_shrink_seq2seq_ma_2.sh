gpu=$1
SAVE_DIR=exp/finetune_w2v_ctc_shrink_seq2seq_ma_2
...
--arch wav2vec_ctc_shrink_seq2seq --task audio_seq2seq --criterion ctc_ce --best-checkpoint-metric uer \
--w2v-path $W2V_PATH --decoder cif_decoder \
