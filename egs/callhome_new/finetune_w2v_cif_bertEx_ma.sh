...
SAVE_DIR=exp/finetune_w2v_cif_rbt3_200M_ma_2
...
--arch wav2vec_cif_bertEx --task audio_cif --criterion cif_bert --best-checkpoint-metric uer \
--w2v-path $W2V_PATH --not-add-ctc-blank \
...
--feature-grad-mult 0.0 --freeze-finetune-updates 500 --gold-updates 20000 \
--validate-after-updates 1  --validate-interval 5 \
