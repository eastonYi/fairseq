...
--num-workers 4 --task speech_recognition --criterion cross_entropy_acc --arch speech_transformer \
...
--max-tokens 30000 --max-update 400000 --seed 2337 --skip-invalid-size-inputs-valid-test --ddp-backend no_c10d \
