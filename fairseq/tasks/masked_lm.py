...
class MaskedLMTask(LegacyFairseqTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--dict', default='dict.txt', type=str,
                            help='dictionary')
    ...
    def setup_task(cls, args, **kwargs):
        ...
        assert len(paths) > 0
        dictionary = Dictionary.load(os.path.join(paths[0], args.dict))
...
@register_task('masked_lm_decoder')
class MaskedLMDecoderTask(MaskedLMTask):
    """Task for training masked language models (e.g., BERT, RoBERTa)."""
