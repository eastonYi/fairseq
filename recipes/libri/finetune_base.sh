...
--attention-dropout 0.0 --max-tokens 1280000 --fix-batches-to-gpus --seed 2337 --log-format json --log-interval 500 --ddp-backend no_c10d --update-freq 3 \
--log-interval 10 --log-format simple --reset-optimizer --data-buffer-size 0
