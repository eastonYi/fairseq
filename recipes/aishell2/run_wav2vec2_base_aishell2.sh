CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python train.py data/aishell2/wav2vec2/manifest \
--save-dir ./exp/wav2vec2_aishell2_base_pretrain --fp16 --num-workers 6 --task audio_pretraining --criterion wav2vec --arch wav2vec2 \
