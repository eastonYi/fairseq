SAVE_DIR=exp/wav2vec2_base_finetune_aishell2_word_phone
W2V_PATH=exp/wav2vec2_base_pretrain/checkpoint_best.pt
DATA_DIR=data/aishell2/train_wav2vec2_finetune/word_phone
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python train.py $DATA_DIR --save-dir $SAVE_DIR --tensorboard-logdir $SAVE_DIR --fp16 \
--wer-args '("data/aishell2/train_wav2vec2_finetune/word_phone/text.aishell2.4gram.arpa.bin","data/aishell2/train_wav2vec2_finetune/word_phone/lexicon.txt",2,-1)' \
