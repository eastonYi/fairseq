SAVE_DIR=exp/wav2vec2_base_finetune_hkust_word_phone_v1
W2V_PATH=exp/wav2vec2_base_pretrain/checkpoint_best.pt
DATA_DIR=data/hkust/train/word_phone_v1
CUDA_VISIBLE_DEVICES=0,1,2,3 python train.py $DATA_DIR --save-dir $SAVE_DIR --tensorboard-logdir $SAVE_DIR --fp16 \
--wer-args '("data/hkust/train/word_phone_v1/hkust.arpa.bin","data/hkust/train/word_phone_v1/lexicon.txt",2,-1)' \
...
--attention-dropout 0.0 --max-tokens 1280000 --seed 2337 --ddp-backend no_c10d --update-freq 6 \
