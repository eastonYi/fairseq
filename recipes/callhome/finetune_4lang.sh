SAVE_DIR=exp/callhome/finetune_4lang
W2V_PATH=exp/base_finetune/checkpoint_best.pt
DATA_DIR=data/callhome/train_4lang
CUDA_VISIBLE_DEVICES=0,2 python train.py $DATA_DIR --save-dir $SAVE_DIR --tensorboard-logdir $SAVE_DIR --fp16 \
--wer-args '("data/callhome/train_4lang/callhome_4lang.arpa.bin","data/callhome/train_4lang/lexicon.txt",2,-1)' \
